...
// Example:
//
//	m := apirun.Migrator{Dir: "./migrations", Store: apirun.StoreOptions{SQLitePath: "./state.db"}, Env: apirun.Env{Global: map[string]string{"k":"v"}}}
...
// SetDefaultLogger sets the global default logger for apirun
