...
var rootCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logger.Info("starting apirun", "config_path", configPath)
		...
		if strings.TrimSpace(configPath) != "" {
			...
			// Store configuration is now only controlled via config file (store.disabled)
		...
		m := apirun.Migrator{Env: baseEnv, Dir: dir, SaveResponseBody: saveResp, TLSConfig: clientTLS}
